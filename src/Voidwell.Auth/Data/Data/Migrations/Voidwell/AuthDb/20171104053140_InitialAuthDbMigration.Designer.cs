...
namespace Voidwell.Auth.Data.Data.Migrations.Voidwell.AuthDb
{
    ...
    [Migration("20171104053140_InitialAuthDbMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voidwell.Auth.Data.Models.SecurityQuestion", b =>
                {
                    b.HasOne("Voidwell.Auth.Data.Models.User")
            ...
            modelBuilder.Entity("Voidwell.Auth.Data.Models.User", b =>
                {
                    b.HasOne("Voidwell.Auth.Data.Models.Authentication", "Authentication")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Voidwell.Auth.Data.Models.Profile", "Profile")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
